  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: 'Total Atlet', value: atlet.length, cls: 'border-blue-100 bg-blue-50 text-blue-700' },
          { label: 'Aktif',       value: atlet.filter(a => a.status === 'aktif').length, cls: 'border-emerald-100 bg-emerald-50 text-emerald-700' },
          { label: 'Tidak Aktif', value: atlet.filter(a => a.status !== 'aktif').length, cls: 'border-gray-100 bg-gray-50 text-gray-600' },
        ].map(s => (
